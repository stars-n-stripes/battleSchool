...
if test "$USER" = "student"; then
	...
	ssh vagrant@127.0.0.1 -p 8507 -i /data/vtest/.vagrant/machines/kali/virtualbox/private_key -X -C -Y "xhost +; xfce4-session; sudo pkill X;  pkill -U vagrant" &>> /tmp/xrdp-student.log
